...
namespace eMuhasebeServer.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            //services.AddScoped<IDocumentViewerRepository, DocumentViewerRepository>(); 
            // Gerek yok. Bu var. internal sealed class DocumentViewerRepository : Repository<DocumentViewerf1menu7, ApplicationDbContext>, 
