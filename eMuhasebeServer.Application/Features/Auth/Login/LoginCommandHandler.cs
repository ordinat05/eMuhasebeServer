        ...
        public async Task<Result<LoginCommandResponse>> Handle(LoginCommand request, CancellationToken cancellationToken)
        {
            ...
            if (signInResult.IsLockedOut)
            {
                ...
                if (timeSpan is not null)
                    ...
                    return (500, "Kullanıcı 3 kez yanlış şifre girdiği için 5 dakika süreyle bloke edilmiştir");
            }

            if (signInResult.IsNotAllowed)
            {
                return (500, "Size Gönderilen Maili Onaylayınız.");
            }
            ...
            //Token içine yerleştirilecek bilgiler burada yerleştiriliyor
